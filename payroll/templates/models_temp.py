...
class Salary(models.Model):
    ...
    basic_salary_per = models.FloatField(validators=[MaxValueValidator(100), MinValueValidator(0)])
    basic_amount = models.DecimalField(decimal_places = 2,
                                        max_digits = 10,
                                        default = decimal.Decimal('0.0000000000')
    )
    hra_per = models.FloatField(validators=[MaxValueValidator(100), MinValueValidator(0)])
    hra_amount = models.DecimalField(decimal_places = 2,
                                        max_digits = 10,
                                        default = decimal.Decimal('0.0000000000')
    )
